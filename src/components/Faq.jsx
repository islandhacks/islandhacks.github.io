...
const Faq = () => {
  ...
  const faqData = [
    ...
    },
    {
      ...
      answer: "This year, IslandHacks is going to be hosted at offices owned by Exelixis, a biotech company located on Bay Farm Island. The address is 1951 Harbor Bay Parkway, Alameda, CA, 94502."
    },
    {
      id: 3,
    ...
    },
    {
      ...
      answer: "IslandHacks is completely led by students, but we'll have plenty of supervisors on hand! Last year, our event was sponsored by AUSD parents, teachers, and other staff members, and this year we'll also have staff from Exelixis supervising!"
    }
  ];
