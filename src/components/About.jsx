...
const About = () => {
  return (
    <section id="about" className="mt-16 flex items-center justify-center px-6 py-4 ">
      <div className="w-full md:max-w-4xl bg-white rounded-xl shadow-lg p-8">
       
        <div className="space-y-4">
          <div>
            <h2 className="text-2xl font-semibold text-green-500">🌴 What is it?</h2>
            <p className="ml-8 mt-4 text-lg">IslandHacks is a 12-hour hackathon meant for students in Alameda to code and win prizes!</p>
          </div>
          
          <div>
            <h2 className="text-2xl font-semibold text-green-500">🖥️ What you'll learn</h2>
          ...
          <div>
            <h2 className="text-2xl font-semibold text-green-500">🤝 Who you'll meet</h2>
